...
public class Simulator {
    ...
    public static void main(String[] args) {
        ...
        try {
            ...
            cd1 = new DistributionCenter(demand, 150, 0, 10, 30, 100, demand.length + 1);
            DistributionCenter cd2 = new DistributionCenter(150, 0, 5, 20, 100, demand.length + 1);
...
//
            GA ga = new GA(100, nodes, demand.length+1, 3000);
            ga.runGA();
